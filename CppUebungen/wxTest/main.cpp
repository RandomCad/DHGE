...
class MyFrame : public wxFrame
{
  public:
    ...
    void OnFileClick(wxTreeEvent &event);
  private:
...
MyFrame::MyFrame(const wxString &title, const wxPoint &pos, const wxSize &size)
  ...
  : wxFrame(nullptr, -1, title, pos, size), splitWin(new wxSplitterWindow(this,-1)),  dirCtrl( new wxGenericDirCtrl(splitWin,-1), textCtrl( new wxTextCtrl(splitWin,-1,;
{
